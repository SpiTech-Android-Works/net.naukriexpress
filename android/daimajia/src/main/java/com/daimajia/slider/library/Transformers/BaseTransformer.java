 ...
 *
 * BaseTransformer implement {@link com.slider.library.Tricks.ViewPagerEx.PageTransformer}
 * which is just same as {@link androidx.core.view.ViewPager.PageTransformer}.
 *
 * After you call setPageTransformer(), transformPage() will be called by {@link com.slider.library.Tricks.ViewPagerEx}
 * when your slider are animating.
 *
 * In onPreTransform() function, that will make {@link com.slider.library.Animations.BaseAnimationInterface}
 * work.
 *
