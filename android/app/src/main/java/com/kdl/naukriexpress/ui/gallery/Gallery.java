...
import com.kdl.naukriexpress.ui.gallery.adapter.GalleryListAdapter;
...
public class Gallery extends BaseActivity {
    ...
    void init() {
        //---------Basic Begin------------
        load(Gallery.this, "Gallery", "Our Gallery");
        ...
        loadData(context, gridView);
    }

    public void loadData(Context context, GridView gridView) {
        ArrayList<DataBin> list = new ArrayList<>();
        GalleryListAdapter adapter = new GalleryListAdapter(context, list);
        gridView.setAdapter(adapter);

        StringRequest stringRequest = new StringRequest(Request.Method.POST, AppConfig.moduleApi + "gallery_list",
                response -> {
                    /*Log.e(tag, response);*/
                    try {
