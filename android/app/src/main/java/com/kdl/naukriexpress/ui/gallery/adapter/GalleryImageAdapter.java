...
import com.kdl.naukriexpress.ui.gallery.GalleryImageViewer;
...
public class GalleryImageAdapter extends BaseAdapter {
    ...
    public GalleryImageAdapter(Context context, ArrayList<DataBin> list) {
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            vi = inflater.inflate(R.layout.gallery_image_row, null);
        ...
        holder.linearLayoutView.setOnClickListener(view1 -> {
            Intent intent=new Intent(context, GalleryImageViewer.class);
            intent.putExtra("gallery_id",data.getGalleryId());
