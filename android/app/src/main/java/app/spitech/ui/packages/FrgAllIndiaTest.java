...
import app.spitech.appSDK.DividerItemDecorator;
import app.spitech.appSDK.BaseFragment;


public class FrgAllIndiaTest extends BaseFragment {

    private RecyclerView recyclerView, recyclerBooks;

    public FrgAllIndiaTest() {

    }

    public static FrgAllIndiaTest newInstance(String param1, String param2) {
        FrgAllIndiaTest fragment = new FrgAllIndiaTest();
    ...
    void init() {
        ...
        AppMethods.getInstance().packageList(getActivity(), recyclerView,null,  "19");
